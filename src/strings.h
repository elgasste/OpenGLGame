...
#define STR_GDFERR_TILEMAPCORRUPT               "Game data file error: tile map memory is corrupt: tile map ID %u"
#define STR_GDFERR_TILEMAPTILESETNOTFOUND       "Game data file error: tile map tile set ID not found: %u"
...
#define STR_GDFWARN_UNKNOWNTILEMAPID            "Game data file warning: unknown tile map ID encountered: %u"
